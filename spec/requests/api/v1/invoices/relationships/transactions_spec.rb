...
RSpec.describe "GET /api/v1/invoices/2/transactions" do
  before(:each) do
    ...
    @transaction_one = create(:transaction, invoice_id: @invoice_two.id, result: "failed")
    @transaction_two = create(:transaction, credit_card_number: "0000000000000000", invoice_id: @invoice_two.id)
  end

  it "returns a list of an invoice's transactions" do

    get "/api/v1/invoices/2/transactions"
